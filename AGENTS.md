...
- `/kkroening/ffmpeg-python` - Python bindings for FFmpeg, enabling creation of complex signal graphs for video and audio processing in a readable Pythonic way
